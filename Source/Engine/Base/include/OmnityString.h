...
namespace Omnity {
	...
	namespace StringUtils {
        ...
        char32_t NextChar(std::basic_string_view<Char>::const_iterator& iter, std::basic_string_view<Char>::const_iterator end);
        char32_t NextChar(std::basic_string<Char>::const_iterator& iter, std::basic_string<Char>::const_iterator end);
	}
