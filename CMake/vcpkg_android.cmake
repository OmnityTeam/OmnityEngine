# FROM
# https://github.com/microsoft/vcpkg-docs/blob/main/vcpkg/examples/vcpkg_android_example_cmake_script/cmake/vcpkg_android.cmake
#
# vcpkg_android.cmake 
#
...
if (VCPKG_TARGET_ANDROID)
    ...
    # ÐÞ·´Ð±¸Üµ¼ÖÂµÄÂ·¾¶´íÎó
    string(REPLACE "\\" "/" CONVERTED_VCPKG_ROOT $ENV{VCPKG_ROOT})
    set(ENV{VCPKG_ROOT} ${CONVERTED_VCPKG_ROOT})
